...
final class ProjectShowPageTest extends WebTestCase
{
    public function testShowDisplaysProjectOverviewAndEntries(): void
    {
        ...
        self::assertSelectorTextContains('body', 'Total tracked');
        self::assertSelectorTextContains('body', 'Landing page work');
    }
}
